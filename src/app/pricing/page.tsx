    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="rounded-2xl border p-6 bg-white">
          ...
          <a href="/app/new" className="mt-6 inline-block rounded border px-4 py-2">
            Empezar
          </a>
        </div>

        <div className="rounded-2xl border p-6 bg-white ring-2 ring-amber-400">
          <h2 className="text-xl font-semibold">Pro</h2>
          <p className="mt-1 text-gray-600">Plantillas premium + IA ampliada</p>
          <p className="mt-6 text-3xl font-bold">
            7,99€<span className="text-base font-normal"> / mes</span>
          </p>
          <a
            href={STRIPE_LINK}
            target="_blank"
